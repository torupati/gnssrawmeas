...
def plot_widelane_ambiguity(ax, rnxobs):
    ...
    nl_pr = L1_FREQ / (L1_FREQ + L2_FREQ) * pr_l1 + L2_FREQ / (L1_FREQ + L2_FREQ) * pr_l2
    
    # Narrow-lane (phase): L1 + L2
    nl_cp = cp_l1 + cp_l2
    # wide-lane (code): L1 - L2
    wl_pr = L1_FREQ / (L1_FREQ - L2_FREQ) * pr_l1 + L2_FREQ / (L1_FREQ - L2_FREQ) * pr_l2
